  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          type="text"
          placeholder="Enter a skill(eg. Javascript, Leadership etc...)"
      ...
      <div className="bg-blue-50 p-3 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Tip:</strong>
          Add 8-10 relevant skills. Include both technical and soft
          skills(programming languages, tools / leadership, communication...)
        </p>
      </div>
    </div>
  );
