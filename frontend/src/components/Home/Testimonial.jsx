    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 text-sm text-indigo-800 bg-rose-400/10 border-2 border-indigo-300 rounded-xl px-4 py-1">
          <BookUserIcon width={14} className="size-4.5 stroke-indigo-600" />
          <span>Testimonials</span>
        </div>

        <Title
          title="Don't just take our words"
          description="Hear what our users say about us. If you have a positive experience with us, leave a review"
        />
      </div>
